...
func InsertAll(db *gorm.DB, entries []Entry) error {
	order := []string{"permission", "dict_type", "dict_data", "site_setting", "role", "user_level", "user", "forum", "forum_mod", "topic", "post", "read_post", "torrent", "news", "comment", "bookmark", "thanks", "snatch", "offer", "message", "invite", "achievement", "medal", "user_medal", "announcement", "shop_item", "lucky_draw_prize"}
